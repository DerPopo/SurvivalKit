...
{
	/// <summary>
	///	Exception that wraps all exceptions that occurred when dispatching an event.
	/// </summary>
	public class EventDispatchingException : Exception, ISurvivalKitException
	{
		/// <summary>
		...
		public EventDispatchingException(string eventName, string eventType, string message, Exception innerException)
...
/****** Start SurvivalKit EventDispatchingException ******/
Message: {0}
Event Name: {1}
Event Type: {2}
